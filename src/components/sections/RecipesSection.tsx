...
export const RecipesSection = memo(() => {
  ...
  return (
    <section ref={ref} className={`py-12 md:py-20 px-4 bg-section-light text-foreground relative overflow-hidden fade-in-up ${isVisible ? 'visible' : ''}`}>
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8 mb-12">
          {recipeCategories.map((category, idx) => (
            <div 
              key={idx} 
              className="bg-section-dark rounded-2xl p-6 md:p-8 border border-white/10 transition-all duration-300 hover:border-gold/30"
            >
