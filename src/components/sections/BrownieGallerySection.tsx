...
const brownieImages = [
  { src: () => import("@/assets/brownie-1.jpg"), alt: "Brownie caseiro irresistível com textura úmida" },
  { src: () => import("@/assets/brownie-2.jpg"), alt: "Brownies gourmet empilhados com cobertura de chocolate" },
  { src: () => import("@/assets/brownie-3.jpg"), alt: "Brownie artesanal com gotas de chocolate" },
  { src: () => import("@/assets/brownie-4.jpg"), alt: "Brownies premium empilhados mostrando textura interna" },
  { src: () => import("@/assets/brownie-5.jpg"), alt: "Brownie feito com receita profissional" },
  { src: () => import("@/assets/brownie-6.jpg"), alt: "Variedade de brownies artesanais" },
  { src: () => import("@/assets/brownie-7.jpg"), alt: "Brownie de chocolate intenso cortado ao meio" },
  { src: () => import("@/assets/brownie-8.webp"), alt: "Brownie embalado profissionalmente para venda" },
  { src: () => import("@/assets/brownie-9.webp"), alt: "Brownies gourmet em embalagens individuais" },
  { src: () => import("@/assets/brownie-10.jpg"), alt: "Brownie caseiro mostrando textura perfeita" },
];
...
export const BrownieGallerySection = memo(() => {
  ...
  if (!isVisible && loadedImages.length === 0) {
    return (
      <section ref={ref} className="py-16 px-4 bg-background min-h-[400px]">
  ...
  return (
    <section ref={ref} className="py-16 px-4 bg-background relative overflow-hidden">
      <div className="container mx-auto relative z-10">
        ...
        <div className="text-center mt-8">
          <p className="text-sm text-white/70">✨ Deslize para ver mais</p>
        </div>
      </div>
    </section>
  );
