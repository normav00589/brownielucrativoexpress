...
// Inline SVG components to avoid lucide-react bundle
          ...
          <div id="master-plan" className="relative">
            ...
            <div className="relative h-full bg-section-light border border-gold/30 rounded-3xl p-8 md:p-10">
              ...
              <div className="flex justify-center gap-1 mt-4 mb-6">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className="w-5 h-5 text-gold fill-gold" viewBox="0 0 24 24" fill="currentColor"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" /></svg>
                ))}
              </div>
              ...
              <ul className="space-y-4 mb-10">
                ...
                <li key={i} className="flex items-start gap-3">
                    <div className="flex-shrink-0 w-6 h-6 rounded-full bg-gradient-to-r from-gold to-[hsl(42,95%,60%)] flex items-center justify-center mt-0.5">
                      <CheckIcon className="w-4 h-4 text-[hsl(20,30%,15%)]" />
                    </div>
