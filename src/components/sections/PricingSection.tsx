      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-10 max-w-5xl mx-auto items-stretch">
          ...
          <div id="master-plan" className="relative">
            ...
            <div className="relative h-full bg-gradient-to-br from-chocolate-dark via-chocolate to-chocolate-dark border-2 border-caramel/50 rounded-3xl p-8 md:p-10">
              ...
              <div className="text-center mb-8">
                ...
                <span className="text-5xl md:text-6xl font-heading font-bold text-transparent bg-gradient-to-r from-gold via-caramel to-gold bg-clip-text">R$13,90</span>
              </div>
          ...
          <div className="relative h-full bg-gradient-to-br from-card via-card/95 to-card border-2 border-border/50 rounded-3xl p-8 md:p-10">
            ...
            <a href="https://danielle-dias.mycartpanda.com/checkout/202036361:1" target="_blank" rel="noopener noreferrer" onClick={() => trackInitiateCheckout(1.99, 'App Brownies Lucrativos - Basic Plan')} className="block w-full py-4 px-8 bg-secondary text-secondary-foreground font-heading font-bold text-lg rounded-xl text-center">
              Começar Agora
            </a>
          </div>
        </div>
