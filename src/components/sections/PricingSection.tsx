      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-premium border-4 border-primary rounded-2xl p-6 md:p-8 shadow-strong relative transform hover:scale-105 transition-all duration-300">
            <div className="absolute -top-3 md:-top-4 left-1/2 -translate-x-1/2 bg-primary text-white px-4 md:px-6 py-1.5 md:py-2 rounded-full font-heading font-bold text-xs md:text-sm shadow-red subtle-pulse">
              🔥 MAIS POPULAR
            </div>
            ...
            <ul className="space-y-3 mb-8">
              ...
              <li className="flex items-start gap-2">
                <Check className="w-5 h-5 text-white flex-shrink-0 mt-0.5" />
                <span className="font-body font-semibold text-sm md:text-base text-white">Apostila "Brownies Natalinos que Vendem"</span>
              </li>
              <li className="flex items-start gap-2">
                <Check className="w-5 h-5 text-white flex-shrink-0 mt-0.5" />
