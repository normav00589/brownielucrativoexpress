        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-10 max-w-5xl mx-auto items-stretch">
          ...
          <div id="master-plan" className="relative">
            ...
            <div className="relative h-full bg-section-light border border-gold/30 rounded-3xl p-8 md:p-10">
              ...
              <a href="https://www.ggcheckout.com/checkout/v3/dGUJ8Ztwl0ct036P2mcl" target="_blank" rel="noopener noreferrer" onClick={() => trackInitiateCheckout(14.90, 'App Completo + Bônus Exclusivos - Master Plan')} className="block w-full py-4 px-8 bg-gradient-to-r from-[hsl(38,90%,55%)] via-[hsl(42,95%,60%)] to-[hsl(38,90%,55%)] text-[hsl(20,30%,15%)] font-heading font-bold text-lg rounded-xl text-center hover:scale-105 transition-transform duration-300" style={{
