...
export const GuaranteeSection = () => {
  return <section className="py-12 md:py-20 px-4" style={{ backgroundColor: 'hsl(0 75% 35%)' }}>
      <div className="container mx-auto max-w-4xl">
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 md:p-12 shadow-strong text-center border-2 border-white/20">
          ...
          <h2 className="font-heading font-bold text-2xl sm:text-3xl md:text-4xl mb-4 md:mb-6 text-white">Garantia de 14 Dias – Satisfação Total</h2>
