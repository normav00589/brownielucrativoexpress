  ...
  return (
    <section ref={ref} className={`py-12 md:py-20 px-4 bg-[hsl(20,22%,8%)] text-foreground relative overflow-hidden fade-in-up ${isVisible ? 'visible' : ''}`}>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Floating particles */}
        <div className="absolute top-20 left-10 w-3 h-3 bg-gold/40 rounded-full animate-pulse" style={{ animationDelay: '0s' }} />
        ...
        <div className="absolute top-1/3 right-1/4 w-2 h-2 bg-gold/60 rounded-full animate-pulse" style={{ animationDelay: '1.5s' }} />
        ...
        {/* Gradient orbs */}
        <div className="absolute -top-20 -left-20 w-64 h-64 bg-gold/5 rounded-full blur-3xl animate-pulse" />
        <div className="absolute -bottom-32 -right-32 w-80 h-80 bg-vibrant-orange/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
        
        {/* Shimmer line */}
        <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-gold/50 to-transparent shimmer-effect" />
      </div>
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="order-2 md:order-1 flex justify-center w-full">
            <div className="relative w-full max-w-xs md:max-w-md mx-auto group">
              ...
              <div className="absolute inset-0 bg-gold/15 rounded-2xl md:rounded-3xl blur-lg scale-105 opacity-50" />
              
              {/* Image with optimization */}
              <img 
                alt="Brownies com casquinha perfeita criados pela Chef Gabriella" 
                className="relative rounded-2xl md:rounded-3xl shadow-lg w-full h-auto border border-gold/30 aspect-[4/3] object-cover" 
              ...
              {/* Chef name badge */}
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-gold via-vibrant-orange to-gold px-4 py-1.5 md:px-5 md:py-2 rounded-full shadow-lg">
          ...
          <div className="space-y-5 md:space-y-6 order-1 md:order-2">
            ...
            <div className="text-center md:text-left">
              ...
              <h2 className="font-heading font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-white leading-tight">
                O Método 3C que{" "}
                <span className="bg-gradient-to-r from-gold to-vibrant-orange bg-clip-text text-transparent">Triplicou Minhas Vendas</span>
              </h2>
            </div>
            ...
            <div className="space-y-4 font-body text-sm md:text-base">
              ...
              <div className="relative group perspective-1000">
                ...
                <div className="absolute -inset-[2px] bg-gradient-to-r from-gold via-vibrant-orange to-gold rounded-xl md:rounded-2xl opacity-75 group-hover:opacity-100 blur-sm transition-all duration-500 animate-gradient-x" />
                <div className="absolute -inset-[1px] bg-gradient-to-r from-vibrant-orange via-gold to-vibrant-orange rounded-xl md:rounded-2xl opacity-60 animate-gradient-x" style={{ animationDelay: '-1s' }} />
                ...
                <div className="absolute inset-0 overflow-hidden rounded-xl md:rounded-2xl pointer-events-none">
                  ...
                  <div className="absolute top-4 right-6 w-1 h-1 bg-gold rounded-full animate-float" style={{ animationDelay: '0.5s' }} />
                  <div className="absolute bottom-3 left-1/3 w-1 h-1 bg-vibrant-orange rounded-full animate-float" style={{ animationDelay: '1s' }} />
                </div>
                
                <div className="relative bg-[hsl(20,22%,10%)] backdrop-blur-md p-5 md:p-6 rounded-xl md:rounded-2xl shadow-2xl text-center md:text-left transform transition-all duration-500 group-hover:scale-[1.02] group-hover:shadow-[0_20px_50px_-12px_rgba(255,180,80,0.3)]">
                  {/* Shimmer overlay */}
                  ...
                  <p className="relative text-xl md:text-2xl lg:text-3xl font-bold flex items-center justify-center md:justify-start gap-3">
                    ...
                    <span className="bg-gradient-to-r from-gold via-vibrant-orange to-gold bg-clip-text text-transparent animate-gradient-x bg-[length:200%_auto]">
                      Casquinha + Cremoso + Caixinha
                    </span>
                  </p>
                  <p className="relative text-white/80 text-sm md:text-base lg:text-lg mt-2 md:mt-3">
                    ...
                    {" "}em{" "}
                    <span className="relative inline-block">
                      <span className="text-gold font-black text-lg md:text-xl animate-pulse">R$200</span>
                      <span className="absolute -inset-1 bg-gold/15 rounded blur-sm animate-pulse" />
                    </span>
                  </p>
                </div>
              </div>
              ...
              {/* Benefits */}
              <div className="bg-[hsl(20,22%,10%)] backdrop-blur-sm p-4 rounded-xl border border-gold/20 shadow-medium">
              ...
              <div className="relative">
                <div className="absolute inset-0 bg-coral/15 rounded-xl blur-md animate-pulse" />
                <div className="relative bg-coral/10 backdrop-blur-sm p-3 md:p-4 rounded-xl border border-coral/30 flex items-center gap-3">
                  <div className="relative">
                    <Clock className="w-5 h-5 md:w-6 md:h-6 text-coral flex-shrink-0 animate-pulse" />
                    <div className="absolute inset-0 bg-coral rounded-full blur-sm opacity-50 animate-ping" />
                  </div>
                  <p className="text-sm md:text-base text-white/90">
                    <span className="font-bold text-coral">Acesso limitado:</span>{" "}
              ...
              <div className="relative group">
                {/* Pulsing rings */}
                <div className="absolute inset-0 rounded-xl bg-gold/20 animate-ping opacity-20" />
                <div className="absolute -inset-1 rounded-xl bg-gradient-to-r from-gold via-vibrant-orange to-gold opacity-50 blur-md group-hover:opacity-80 group-hover:blur-lg transition-all duration-500 animate-pulse" />
                <div className="absolute -inset-[2px] rounded-xl bg-gradient-to-r from-gold via-vibrant-orange to-gold animate-gradient-x opacity-80" />
                
                <Button 
                  size="lg" 
                  className="relative w-full text-base md:text-xl font-bold py-5 md:py-7 bg-gradient-to-r from-vibrant-orange via-gold to-vibrant-orange hover:from-gold hover:via-vibrant-orange hover:to-gold shadow-[0_10px_40px_-10px_rgba(255,180,80,0.4)] hover:shadow-[0_20px_60px_-10px_rgba(255,180,80,0.6)] transform hover:scale-[1.03] transition-all duration-500 overflow-hidden group/btn text-white" 
                  onClick={() => {
