      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-8 md:mb-12">
          <h2 className="font-heading font-bold text-2xl sm:text-3xl md:text-4xl text-white mb-4">
            Mais de <span className="bg-gradient-to-r from-hot-pink to-vibrant-orange bg-clip-text text-transparent">3.000 alunos</span> já estão lucrando com o Método 3C!
          </h2>
        ...
        <div className="relative px-4 md:px-20">
          ...
          >
            <CarouselContent>
              {realTestimonials.map((image, index) => (
                <CarouselItem key={index}>
                  <div className="p-2">
                    <div className="bg-[hsl(20,20%,12%)] rounded-2xl shadow-lg border-2 border-hot-pink/30 overflow-hidden">
                      <img 
                        src={image} 
            ...
            <CarouselPrevious className="left-2 md:left-4 h-12 w-12 bg-hot-pink/20 border-hot-pink/50 text-hot-pink hover:bg-hot-pink hover:text-white" />
            <CarouselNext className="right-2 md:right-4 h-12 w-12 bg-hot-pink/20 border-hot-pink/50 text-hot-pink hover:bg-hot-pink hover:text-white" />
          </Carousel>
        </div>
      </div>
    </section>
